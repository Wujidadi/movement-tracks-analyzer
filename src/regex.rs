...
mod tests {
    ...
    fn test_start_time_pattern_matches() {
        let html = r#"<b>Start: </b>2026-03-11 10:30:45<br />"#;
    ...
    fn test_start_time_pattern_captures() {
        ...
        assert!(caps.is_some());
        let cap = caps.unwrap();
        assert_eq!(cap.get(1).unwrap().as_str(), "2026-03-11 10:30:45");
    }
    ...
    fn test_end_time_pattern_matches() {
        let html = r#"<b>End: </b>2026-03-11 11:30:45"#;
    ...
    fn test_end_time_pattern_captures() {
        ...
        assert!(caps.is_some());
        let cap = caps.unwrap();
        assert_eq!(cap.get(1).unwrap().as_str(), "2026-03-11 11:30:45");
    }
    ...
    fn test_end_time_pattern_without_br() {
        ...
        let html_with_br = r#"<b>End: </b>2026-03-11 11:30:45<br />"#;
